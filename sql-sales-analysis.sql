...
VALUES 
(2, 2, 'Fuller', 'Andrew', 'Vice President', 'Dr.', '02/9/1952', '08/4/1992', 10000.00, NULL),
(8, 2, 'Callahan', 'Laura', 'Sales Assistant', 'Miss', '01/09/58', '03/05/94', 2000.00, NULL),
(4, 2, 'Peacock', 'Margaret', 'Sales Representative', 'Mrs.', '09/9/58', '05/03/93', 2856.00, 250.00),
(3, 2, 'Leverling', 'Janet', 'Sales Representative', 'Miss', '08/10/63', '04/01/92', 3500.00, 1000.00),
(1, 2, 'Davolio', 'Nancy', 'Sales Representative', 'Miss', '12/08/68', '05/01/92', 3135.00, 1500.00),
(5, 2, 'Buchanan', 'Steven', 'Sales Manager', 'Mr.', '03/04/55', '10/7/93', 8000.00, NULL),
(9, 5, 'Dodsworth', 'Anne', 'Sales Representative', 'Miss', '07/02/69', '11/5/94', 2180.00, 0.00),
(6, 5, 'Suyama', 'Michael', 'Sales Representative', 'Mr.', '07/02/63', '10/7/93', 2534.00, 600.00),
(7, NULL, 'King', 'Robert', 'Sales Representative', 'Mr.', '05/9/60', '01/02/94', 2356.00, 800.00);
...
SELECT CONVERT(VARCHAR(10), ORDER_DATE, 23) AS OrderDate, CONVERT(VARCHAR(10), SHIP_DATE, 23) AS ShipDate
FROM [dbo].[ORDERS]
...
INSERT INTO ORDERS  VALUES ( 10381,'LILAS',3,'1096-12-12','1996-12-13', 39.95 );
...
INSERT INTO ORDERS  VALUES ( 10603,'SAVEA',8,'1997-07-18','1997-08-01', 243.85 );
...
INSERT INTO ORDERS  VALUES ( 10714,'SAVEA',5,'1997-10-22','1997-10-21', 122.45 );
INSERT INTO ORDERS  VALUES ( 10716,'RANCH',4,'1997-10-24','1997-11-27', 112.85 );
...
INSERT INTO ORDERS  VALUES ( 11049,'GOURL',3,'1998-04-24','1998-04-04', 41.70 );
...
-- 1. Display in descending order of seniority the male employees whose net salary
--(salary + commission) is greater than or equal to 8000.
--The resulting table should include the following columns:
--Employee Number, First Name and Last Name, Age, and Seniority.

SELECT EMPLOYEE_int AS 'Employee Number', CONCAT(FIRST_NAME, ' ', LAST_NAME) AS Employee_Name, (2025 - YEAR(BIRTH_DATE)) AS Age, (SALARY + ISNULL(COMMISSION, 0)) AS Seniority
FROM [dbo].[EMPLOYEES]
WHERE (SALARY + ISNULL(COMMISSION, 0)) >= 8000 AND TITLE = 'Mr.'
ORDER BY Seniority DESC;

-- 2. Display products that meet the following criteria: (C1) quantity is packaged in bottle(s), 
...
--(C5) units ordered are specified (not null). The resulting table should include the following columns:
--product number, product name, supplier number, units ordered, and unit price.

SELECT PRODUCT_REF AS 'Product_name', PRODUCT_NAME, SUPPLIER_int AS 'Supplier_num', UNITS_ON_ORDER, UNIT_PRICE
FROM [dbo].[PRODUCTS]
WHERE QUANTITY = '%bottle%'
AND PRODUCT_NAME = '__t%' OR PRODUCT_NAME = '__T%'
AND SUPPLIER_int IN (1, 2, 3)
AND UNIT_PRICE BETWEEN 70 AND 200
AND UNITS_ON_ORDER IS NOT NULL;

-- 3. Display customers who reside in the same region as supplier 1, meaning they share the same country,
--city, and the last three digits of the postal code. The query should utilize a single subquery. 
--The resulting table should include all columns from the customer table.

SELECT * 
FROM CUSTOMERS
WHERE COUNTRY = (SELECT COUNTRY FROM [dbo].[SUPPLIERS] WHERE SUPPLIER_int = 1)
	AND CITY = (SELECT CITY FROM [dbo].[SUPPLIERS] WHERE SUPPLIER_int = 1)
    AND RIGHT(POSTAL_CODE, 3) = (SELECT RIGHT(POSTAL_CODE, 3) FROM [dbo].[SUPPLIERS] WHERE SUPPLIER_int = 1 );
...
--(unit price * quantity) is between 0 and 2000, 5% if between 2001 and 10000,
--10% if between 10001 and 40000, 15% if between 40001 and 80000, and 20% otherwise.
--Display the message "apply old discount rate" if the order number is between 10000 and 10999, 
--and "apply new discount rate" otherwise. The resulting table should display the columns: 
--order number, new discount rate, and discount rate application note.

SELECT *
FROM [dbo].[ORDER_DETAILS]

SELECT ORDER_int AS 'ORDER_NUM',
	CASE 
...
-- 5. Display suppliers of beverage products. The resulting table should display the columns:
-- supplier number, company, address, and phone number.

SELECT S.SUPPLIER_int AS 'SUPPLIER_NO', S.COMPANY, S.ADDRESS, S.PHONE
...
INNER JOIN [dbo].[PRODUCTS] P
ON S.SUPPLIER_int = P.SUPPLIER_int
WHERE P.CATEGORY_CODE = (SELECT CATEGORY_CODE
							FROM [dbo].[CATEGORIES]
							WHERE CATEGORY_NAME = 'Beverages');


-- 6. Display customers from Berlin who have ordered at most 1 (0 or 1) dessert product.
...
HAVING COUNT(CASE WHEN P.CATEGORY_CODE = 3 THEN 1 END) <= 1
...
-- 7. Display customers who reside in France and the total amount of orders they placed every Monday in April 1998
...
-- 8. Display customers who have ordered all products. The resulting table should display the columns:
...
SELECT C.CUSTOMER_CODE, COUNT(O.ORDER_int) AS No_of_Orders
FROM [dbo].[CUSTOMERS] C
LEFT JOIN [dbo].[ORDERS] O
ON C.CUSTOMER_CODE = O.CUSTOMER_CODE
WHERE C.COUNTRY = 'France'
...
-- 10. Display the number of orders placed in 1996, the number of orders placed in 1997,
...
SELECT 
	...
	COUNT(CASE WHEN YEAR(ORDER_DATE) = 1997 THEN 1 END) AS ORDERS_1996,
